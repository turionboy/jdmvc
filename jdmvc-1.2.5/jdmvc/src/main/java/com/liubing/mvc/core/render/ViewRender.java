...
public interface ViewRender {
	 ...
	 * @param response
	 * @param result
	 * @param returnType 返回类型，json，String json需要格式化，系统默认提供fastjson方式
	 * @throws Exception
	  */
	 public void renderResult(HttpServletRequest request,HttpServletResponse response,Object result,String returnType) throws Exception;    
	 /**
	  * 
	 * <p>Title: 初始化</p> 
	 * <p>Description: </p> 
