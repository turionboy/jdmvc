...
public class FreemarkerViewRender implements ViewRender {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.jd.mvc.core.render.ViewRender#renderPage(javax.servlet.http.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.jd.mvc.core.render.ViewRender#renderResult(javax.servlet.http.
	 * HttpServletRequest, javax.servlet.http.HttpServletResponse,
	...
	public void renderResult(HttpServletRequest request,
		...
		if (returnType.equalsIgnoreCase("json")
				|| returnType.equalsIgnoreCase("jsonp")) {
			if (result.getClass().isPrimitive()
					|| result.getClass().getName().startsWith("java.")) {// java
																			// 基本类型
	...
	public void init(ServletContext servletContext) {
		...
		if (!StringUtil.isNullOrEmpty(servletContext
				.getInitParameter("templates"))) {
			cfg.setServletContextForTemplateLoading(servletContext,
					servletContext.getInitParameter("templates"));
		} else {
			cfg.setServletContextForTemplateLoading(servletContext,
					"WEB-INF/templates");
		}
